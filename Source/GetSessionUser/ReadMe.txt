========================================================================
    KONSOLENANWENDUNG: GetSessionUser-Projektübersicht
========================================================================

Diese GetSessionUser-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die GetSessionUser-Anwendung besteht.


GetSessionUser.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen GetSessionUser.pch sowie eine vorkompilierte 
